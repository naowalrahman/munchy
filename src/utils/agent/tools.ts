...
import { logFoodEntry, getFoodLogsForDate, FoodLogEntry, deleteFoodEntry } from "@/app/actions/foodLog";
...
const searchFoodsTool = tool({
  ...
  parameters: z.object({
    query: z
      .string()
      .describe("The food name or description to search for (e.g., 'chicken breast', 'apple', 'coca cola')"),
