...
function MessageBubble({
            ...
            >
                ...
                {message.toolResult && (
                    ...
                    >
                        ...
                        <Text whiteSpace="pre-wrap">
                            {(message.toolResult as { text?: string })?.text}
                        </Text>
                    </Box>
                )}
                {!message.toolResult && (
    ...
    return (
        ...
        >
            <Text
                color={isUser ? "white" : "text.default"}
                whiteSpace="pre-wrap"
                lineHeight="tall"
            >
                {message.content}
                    ...
                    {displayMessages.length === 0 && (
                        ...
                        >
                            ...
                            <Text color="text.muted" maxW="md" mx="auto">
                                I can help you search for foods, log your meals, check your
                                daily nutrition, and answer questions about health and
                                nutrition.
                            </Text>
                            <VStack mt={6} gap={2}>
                                <Text fontSize="sm" color="text.muted">
