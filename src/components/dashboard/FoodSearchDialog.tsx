...
export function FoodSearchDialog({
    ...
    const startScanner = useCallback(async () => {
        ...
        try {
            ...
            setScannerError(
                message.includes("NotAllowed") ? "Camera permission denied." :
                message.includes("NotFound") ? "No camera found." :
                message.includes("NotReadable") ? "Camera in use by another app." :
                message
            );
        } finally {
                                ...
                                <VStack gap={4} align="stretch">
                                    ...
                                    >
                                        ...
                                        {isStartingScanner && (
                                            ...
                                            >
                                                <Spinner size="lg" colorPalette="brand" />
                                                <Text color="white" fontSize="sm">Starting camera...</Text>
                                            </Box>
                                        )}
